...
public class PlayerAttackEffects : MonoBehaviour
{
    ...
    public GameObject groundImpact_Spawn;
    public GameObject kickFX_Spawn;
    public GameObject fireTornado_Spawn;
    public GameObject fireShield_Spawn;

    public GameObject groundImpact_Prefab;
    public GameObject kickFX_Prefab;
    public GameObject fireTornado_Prefab;
    public GameObject fireShield_Prefab;
    public GameObject healFX_Prefab;
    public GameObject thunderFX_Prefab;
